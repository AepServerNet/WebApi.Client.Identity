...
namespace AspNetCore_Client_CallAPI
{
    class Program
    {
        ...
        {
            var client = new RestClient("https://localhost:44346/api/Authenticate/login");
            var request = new RestRequest(Method.POST);

            client.Timeout = -1;

            LoginInputModel emp = new();
            emp.username = "user-noadmin";
            emp.password = "Password1234!";
            ...
            var client2 = new RestClient("https://localhost:44346/api/WeatherForecast");
            client2.Timeout = -1;
